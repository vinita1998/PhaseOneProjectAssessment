...
import com.training.entities.Directory;
...
public class FileOptionsScreen implements Screen {
    ...
    public FileOptionsScreen() {
    	...
    	options.add("1. To Add File");
        options.add("2. To Delete File");
        options.add("3. To Search File");
    ...
    @Override
    public void Show() {
    	System.out.println("Menu For File Options");
    ...
    public void AddFile() {
        ...
        System.out.println("Your File has been successfully added: " + fileName);
